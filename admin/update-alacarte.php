...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM alacarte WHERE food_ID=$id";
        //execute the Query
        ...
        $current_image = $row2['food_image'];
        $status = $row2['food_status'];
    }
    else
    {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        if($upload==false)
                        {
                            ...
                            header('location:update-alacarte.php');
                            //Stop the process
                            die();
                        }
